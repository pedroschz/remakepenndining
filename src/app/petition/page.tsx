    ...
    <article className="container-edit py-16 md:py-24 max-w-3xl">
      ...
      <FadeIn delay={0.1} className="mt-16 prose-custom space-y-8 text-ink-soft leading-[1.75] text-[1.0625rem]">
        <p className="drop-cap font-serif text-[1.15rem] leading-[1.7] text-ink">
          ...
          that has logged <strong className="text-ink">100+ health code
          observations in a single 2023 inspection cycle</strong>, documented
        ...
        <Section title="A 13-year pattern of sanitation failures">
          <p>
            ...
            <strong className="text-ink">100 total observations of health
            code violations</strong> across Penn Dining facilities. Hill House
            Dining logged 16 distinct violations and 38 points of concern —
            including <strong className="text-ink">six separate sightings of
            mouse droppings</strong>, two in direct contact with pans and
          ...
          <p>
            ...
            inspectors found a{" "}
            <strong className="text-ink">dead mouse on a sticky trap in
            1920 Commons&rsquo; canned-food storage room</strong>, cited
            explicitly as a repeat violation under Category 53. At Houston
            Market, inspectors logged ten violations in a single visit —
            including cooked eggs held overnight at improper temperature that
            were discarded by the inspector.
          </p>
        </Section>
        ...
        <Section title="What students pay, and what they get">
          ...
          <p>
            ...
            2022 Class of 2025 GroupMe poll found{" "}
            <strong className="text-ink">only 4.9% satisfied</strong> with Penn
            Dining. A 2016 DP survey of 290 freshmen found{" "}
            <strong className="text-ink">~80% wished they did not have to
            be on a meal plan</strong>. Penn's contract with BAMCO has not been
        ...
        <Section title="Peers who self-operate deliver better food for comparable or lower cost">
          <p>
            ...
            Cornell $7,328 — all self-operated, ranked peers.{" "}
            <strong className="text-ink">Johns Hopkins ended its BAMCO
            contract in 2022</strong> and rehired every hourly worker as a JHU
        ...
        <Section title="BAMCO has a documented labor record — at Penn and nationally">
          <p>
            ...
            to <strong className="text-ink">lay off ~140 Penn retail dining
            workers without pay</strong>. A student petition drew 8,322
            signatures in days and Penn reversed course — but the episode
        ...
        <Section title="What we're asking for">
          <ol className="list-decimal pl-6 space-y-3 marker:text-accent marker:font-serif marker:text-lg">
            ...
            <li>
              ...
              worker</strong> — both AFSCME residential staff and Teamsters
              Local 929 retail staff — as direct University employees at
        ...
        <p className="pt-6 font-serif text-xl text-ink italic leading-snug">
          The record supports every major factual claim of this petition. The
          question is no longer whether BAMCO&rsquo;s performance justifies
          termination; it is whether Penn is willing to meet the standard its
