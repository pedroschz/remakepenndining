      ...
      <section className="container-edit pt-16 md:pt-24 pb-8">
        <FadeIn className="max-w-3xl">
          ...
          <p className="mt-6 text-lg text-ink-soft leading-relaxed">
            Every entry below is either a Philadelphia Department of Public Health 
            inspection finding or a documented Daily Pennsylvanian report. Each has a primary source.
          </p>
        </FadeIn>
      </section>
      <Timeline />
